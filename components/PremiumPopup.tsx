...
import { Modal, StyleSheet, View, TouchableOpacity, ScrollView, Linking, Platform } from "react-native";
...
export function PremiumPopup({ visible, onDismiss }: PremiumPopupProps) {
  ...
  const savingsPercent = Math.round(((monthlyPrice * 3) - quarterlyPrice) / (monthlyPrice * 3) * 100);
        ...
        <Card style={[styles.popup, { backgroundColor: theme.card }]}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.header}>
              <View style={[styles.crownIcon, { backgroundColor: theme.primary }]}>
            ...
            <View style={styles.features}>
              <FeatureItem icon="📅" text={t('premiumFeature1Title')} theme={theme} />
              <FeatureItem icon="⏱️" text={t('premiumFeature2Title')} theme={theme} />
              <FeatureItem icon="🔔" text={t('premiumFeature3Title')} theme={theme} />
              <FeatureItem icon="📊" text={t('premiumFeature4Title')} theme={theme} />
              <FeatureItem icon="💾" text={t('premiumFeature5Title')} theme={theme} />
            </View>
            ...
            <View style={styles.pricingSection}>
              ...
              >
                ...
                <View style={styles.priceRow}>
                  ...
                  <ThemedText style={styles.period}> {t('uzs')}/{t('month')}</ThemedText>
                </View>
              </TouchableOpacity>

              {/* Quarterly Plan */}
              <TouchableOpacity
                style={[styles.planCard, styles.recommendedPlan, { borderColor: theme.primary, backgroundColor: theme.primaryLight }]}
                onPress={() => handleBuyPremium("quarterly")}
              >
                <View style={[styles.bestBadge, { backgroundColor: theme.primary }]}>
                  <Zap size={10} color="#fff" fill="#fff" />
                  <ThemedText style={styles.bestBadgeText}>{t('bestValue')}</ThemedText>
                </View>
                ...
                <View style={styles.savingsRow}>
                  ...
                  <View style={styles.savingsBadge}>
                    <ThemedText style={styles.savingsText}>{t('save_m')} {savingsPercent}%</ThemedText>
                  </View>
                </View>
                <View style={styles.priceRow}>
                  <ThemedText style={[styles.price, { color: theme.primary }]}>
                  ...
                  <ThemedText style={styles.period}> {t('uzs')}/3{t('months')}</ThemedText>
                </View>
              </TouchableOpacity>
            </View>
